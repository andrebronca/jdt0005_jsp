...
<script type="text/javascript" src="<%= path %>/assets/pages/widget/excanvas.js "></script>
<!-- waves js -->
<script src="<%= path %>/assets/pages/waves/js/waves.min.js"></script>
...
<!-- slimscroll js -->
<script type="text/javascript" src="<%= path %>/assets/js/SmoothScroll.js"></script>
<script src="<%= path %>/assets/js/jquery.mCustomScrollbar.concat.min.js "></script>
<!-- Chart js -->
<script type="text/javascript" src="<%= path %>/assets/js/chart.js/Chart.js"></script>
<!-- amchart js -->
<script src="https://www.amcharts.com/lib/3/amcharts.js"></script>
<script src="<%= path %>/assets/pages/widget/amchart/gauge.js"></script>
<script src="<%= path %>/assets/pages/widget/amchart/serial.js"></script>
<script src="<%= path %>/assets/pages/widget/amchart/light.js"></script>
<script src="<%= path %>/assets/pages/widget/amchart/pie.min.js"></script>
<script src="https://www.amcharts.com/lib/3/plugins/export/export.min.js"></script>
<!-- menu js -->
<script src="<%= path %>/assets/js/pcoded.min.js"></script>
<script src="<%= path %>/assets/js/vertical-layout.min.js "></script>
<!-- custom js -->
<script type="text/javascript" src="<%= path %>/assets/pages/dashboard/custom-dashboard.js"></script>
