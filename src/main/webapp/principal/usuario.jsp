...
<body>
								...
								<div class="page-wrapper">
									...
									<div class="page-body">
										...
										<div class="col-sm-12">
											...
											<div class="card">
												...
												<div class="card-block">
													...
													<form id="formUser" class="form-material" method="post"
														action="<%=path%>/ServletUsuarioController">
														<input type="hidden" name="acao" id="acao" value="">
														<div class="form-group form-default form-static-label">
															<input type="text" name="id" id="id" class="form-control"
																readonly="readonly" value="${mLogin.id}"> <span
														...
														<div class="form-group form-default">
															...
															<input type="text" name="email" id="email"
																...
																required="required" value="${mLogin.email}"> <span
																class="form-bar"></span> <label class="float-label">E-mail</label>
														</div>
														<div class="form-group form-default">
															<input type="text" name="login" id="login"
																class="form-control" required="required"
																value="${mLogin.login}"> <span class="form-bar"></span>
															<label class="float-label">Login</label>
														</div>
														<div class="form-group form-default">
															<input type="password" name="senha" id="senha"
																autocomplete="off" class="form-control"
																required="required" value="${mLogin.senha}"> <span
																class="form-bar"></span> <label class="float-label">Senha</label>
														</div>
														<button type="button"
															class="btn btn-success btn-out waves-effect waves-light"
															onclick="limparForm();">Novo</button>
														<button type="button"
															class="btn btn-warning btn-out waves-effect waves-light"
															onclick="deletarUser();">Remover</button>
														<button type="button"
															class="btn btn-warning btn-out waves-effect waves-light"
															onclick="deleteComAjax();">Remover (Ajax)</button>
														<button type="submit"
															class="btn btn-primary btn-out waves-effect waves-light">Salvar</button>
														<button type="button"
															class="btn btn-secondary btn-out waves-effect waves-light"
										...
										<div style="height: 300px; overflow: scroll;">
											<table class="table table-hover" id="listaTodosUsuarios">
												<thead>
													<tr>
														<th scope="col">ID</th>
												...
												<tbody>
													<c:forEach items="${usersLista}" var="u">
														<tr>
															...
															href="<%=path%>/ServletUsuarioController?acao=buscarEditar&id=${u.id}">Editar</a></td>
															<!-- deixar salvo as duas formas para histórico -->
															<td><button class="btn btn-outline-success" type="button"
															onclick="verEditar(${u.id});">Editar</button></td>
															<!-- TODO Fazer um botão para remover -->
														</tr>
													</c:forEach>
												</tbody>
											</table>
				...
				<div class="modal-body">
					...
					<div class="input-group mb-3">
						<input type="text" class="form-control"
							placeholder="Nome do usuário" id="txt_buscar_nome"
	...
	<script type="text/javascript">
		...
		function buscarUsuario() {
			let nome_buscar = document.getElementById('txt_buscar_nome').value
					.trim();
			...
			if (nome_buscar != null && nome_buscar != '') {
				...
				$.ajax({
					...
					data : 'acao=buscarNomeAjax&nomebuscar='
							+ nome_buscar,
					success : function(response) {
						let lista_usuarios = JSON
								.parse(response);
						$(
								'#listaUsuariosPesquisados > tbody > tr')
								.remove();
						...
						for (let i = 0; i < lista_usuarios.length; i++) {
							...
							$(
									'#listaUsuariosPesquisados > tbody')
									.append(
											'<tr>'
													+ '<td>'
													+ idUser
													...
													+ nomeUser
													+ '</td>'
													+ '<td><button type="button" onclick="verEditar('
													+ idUser
													+ ');" class="btn btn-info btn-out waves-effect waves-light">Ver</button></td>'
													+ '</tr>');
						}
						$('#totalResultados')
								.text(
										'Total de resultados: '
												+ lista_usuarios.length);
